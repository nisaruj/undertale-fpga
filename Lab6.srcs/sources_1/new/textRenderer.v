...
module textRenderer(
    ...
    Pixel_On_Text2 #(.displayText("6031057621 Sorawit Sunthawatrodom")) t2(
        clk, 200, 150, x, y, member2);
    Pixel_On_Text2 #(.displayText("6031044421 Pawat Amornpitakpun")) t3(
        clk, 200, 200, x, y, member3);
    Pixel_On_Text2 #(.displayText("6030559121 Siwat Pongpanit")) t4(
        clk, 200, 250, x, y, member4);
    Pixel_On_Text2 #(.displayText("6030064821 Khanisorn Khemthong")) t5(
